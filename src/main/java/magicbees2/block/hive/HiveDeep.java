...
import magicbees2.api.apiculture.hives.HiveStone;
...
public class HiveDeep extends HiveStone {
	
	public HiveDeep(float genChance) {
		super(IBlocks.hive, 3, genChance, Blocks.stone);
	...
	private void initPopulation() {
		...
		String uid1 = "magicbees2.species.attuned";
