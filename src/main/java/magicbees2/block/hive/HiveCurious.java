...
import magicbees2.api.apiculture.hives.HiveTree;
...
public class HiveCurious extends HiveTree {

	public HiveCurious(float genChance) {
		super(IBlocks.hive, 0, genChance);
	...
	private void initPopulation() {
		...
		String uid1 = "magicbees2.species.mystical";
