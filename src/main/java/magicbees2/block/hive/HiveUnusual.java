...
public class HiveUnusual extends HiveGround {

	public HiveUnusual(float genChance) {
		super(IBlocks.hive, 1, genChance, Blocks.grass);
	...
	private void initPopulation() {
		...
		String uid1 = "magicbees2.species.unusual";
